...
class VideoAdapter(options: FirestoreRecyclerOptions<ShortVideos>,val applicationContext: Context) : FirestoreRecyclerAdapter<ShortVideos, VideoAdapter.VideoViewHolder>(
    options
) {
